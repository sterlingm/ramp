...
const ramp_msgs::MotionState LineSL::buildMotionState(const ReflexxesData data) 
{
...
const bool LineSL::finalStateReached() 
{
...
void LineSL::init(const ramp_msgs::MotionState start, 
...
void LineSL::changeReflexxes()
{
  ...
  // Set up the motion constraints (max velocity, acceleration and jerk)
  // Maximum velocity   
  reflexxesData_.inputParameters->MaxVelocityVector->VecData[0] = final_speed_+0.00001;
  reflexxesData_.inputParameters->MaxVelocityVector->VecData[1] = final_speed_+0.00001;
  reflexxesData_.inputParameters->TargetVelocityVector->VecData[0] = final_speed_;
...
void LineSL::setReflexxesCurrent() {
...
void LineSL::setReflexxesTarget() {
...
void LineSL::setReflexxesSelection() {
...
const ramp_msgs::MotionState LineSL::spinOnce() 
{
