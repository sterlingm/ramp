...
public:
  ...
  void init(const ramp_msgs::MotionState s, const ros::Duration sl_init_dur, const ros::Duration sl_final_dur, const double sl_final_speed=-1);
private:
  ...
  double final_speed_;
  ros::Duration d_init_;
  ros::Duration d_final_;
};
