...
directory_prefix = 'system_level_data';
abtc = '8';
...
% and get the data
for i=1:size(f_fe,2)
    data_fe(1:num_tests,i) = importdata(f_fe{i});
    data_re(1:num_tests,i) = importdata(f_re{i});
    data_ic_st(1:num_tests,i) = importdata(f_ic_st{i});
