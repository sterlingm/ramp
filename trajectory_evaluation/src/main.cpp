                   ...
                   ramp_msgs::EvaluationSrv::Response& resps) 
{
  ...
  for(uint8_t i=0;i<s;i++)
  {
    ...
    ROS_INFO("full_eval: %s consider_trans: %s trans_possible: %s", reqs.reqs[i].full_eval ? "True" : "False", reqs.reqs[i].consider_trans ? "True" : "False", reqs.reqs[i].trans_possible ? "True" : "False");*/
