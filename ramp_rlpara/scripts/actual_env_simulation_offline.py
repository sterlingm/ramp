...
TODO: don't use rosnode kill in ramp_planner, use process name to get pid and use ctrl+c to interrupt the node (prefered) or
...
while True: # TODO: enable key interrupt or some other
    ...
    os.system('roslaunch ramp_launch planner_full_costmap_simulation_offline.launch')
