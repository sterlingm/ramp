 ...
 *  else, then [y, x]
 */
const std::vector<double> Move::getNewPosition(const double value, const double other_value, const double bound, const double theta, const double r, bool x_dim) const
{
